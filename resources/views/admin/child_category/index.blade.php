...
@section('title', 'All Child Categories')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <form class="row align-items-end" action="{{ route('admin.child_category.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select name="category_id" id="" class="form-select js-example-basic-single" onchange="get_sub_category()" required>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select name="sub_category_id" id="" class="form-select js-example-basic-single" required>
...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("admin.child_category.datatable") }}', { page:page, value:value, search:search, status:status }, function(data){
        ...
        function edit_modal(id){
            ...
            $.get('{{ route('admin.child_category.edit') }}', { id:id }, function(data){
        ...
        function change_status(id){
            ...
            $.get('{{ url('admin/child_category/status') }}/'+id, function(data){
        ...
        function get_sub_category(){
            var category_id = $('.card-header select[name="category_id"]').val();
            $('.card-header select[name="sub_category_id"]').prop('disabled',true);
            $.get('{{ url('get_sub_category') }}', { category_id:category_id }, function(data){
                $('.card-header select[name="sub_category_id"]').html(data);
                $('.card-header select[name="sub_category_id"]').prop('disabled',false);
