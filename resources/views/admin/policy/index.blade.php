...
@section('breadcrumb-items')
    <li class="breadcrumb-item">Policy Management</li>
@endsection
@section('btns')
    <a href="#" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#edit_modal" onclick="edit_modal(0)">Add Policy</a>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    {{-- <div class="card-header">
                        <form class="row align-items-end" action="{{ route('admin.policy.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            <h4 class="card-title col-auto">All Policys</h4>
...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("admin.policy.datatable") }}', { page:page, value:value, search:search, status:status }, function(data){
        ...
        function edit_modal(id){
            ...
            $.get('{{ route('admin.policy.edit') }}', { id:id }, function(data){
        ...
        function change_status(id){
            ...
            $.get('{{ url('admin/policy/status') }}/'+id, function(data){
