        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group mb-3">
             ...
             <div class="col-md-12 form-group mb-3">
                ...
                <div class="img-box">
                    <a href="{{ $sub_category->image_url ?? asset('no_image.jpg') }}" target="_blank"><img src="{{ $sub_category->thumb_url ?? asset('no_image.jpg') }}" alt="" style="width: 60px; height: 60px; object-fit: cover"></a>
                </div>
            </div>
