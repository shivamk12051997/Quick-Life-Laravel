...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("admin.doctor_profile.datatable") }}', { page:page, value:value, search:search, status:status }, function(data){
        ...
        function edit_modal(id){
            ...
            $.get('{{ route('admin.doctor_profile.edit') }}', { id:id }, function(data){
        ...
        function change_status(id){
            $('#ajax_html').html('<div class="loader-box"><div class="loader-37"></div></div>');
            $.get('{{ url('admin/doctor_profile/change_status') }}', { id:id }, function(data){
                $('#ajax_html').removeClass();
