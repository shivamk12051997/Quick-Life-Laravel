...
@section('script')
    <script>
        ...
        function get_datatable(page){
            ...
            var page = page ?? 1;
            $.get('{{ route("warehouse.current_stock.datatable") }}', { page:page, value:value, search:search, status:status, warehouse_filter:warehouse_filter, stock_filter:stock_filter, brand_filter:brand_filter, category_filter:category_filter }, function(data){
