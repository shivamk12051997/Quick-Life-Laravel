...
class ChildCategory extends Model implements HasMedia
{
    ...
    {
    	return $this->hasMany('App\Models\Product', 'child_category_id', 'id')->where('status', 1);
    }
    ...
    {
        return $this->belongsTo('App\Models\SubCategory', 'sub_category_id', 'id')->where('status', 1);
    }
}
